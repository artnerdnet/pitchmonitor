export const computeMagnitudes = (frequencies) => {   // Compute the (squared) magnitudes of the complex amplitudes for each note frequency
...
export const calculateAverageMagnitudeValues = (magnitudes, strongestMagnitude) => {
...
export const getMaximumMagnitude = (magnitudes) => {
